var AleUtil = (function ($) {
    ...
    obj.localidades = [
        ...
        { nombre: "ARIAS", grupos: ["TODAS", "ROSARIO", "STAFE"] },
        ...
        { nombre: "CORRAL DE BUSTOS", grupos: ["TODAS", "ROSARIO", "STAFE"] },
        { nombre: "CORREA", grupos: ["TODAS", "ROSARIO", "STAFE"] },
        { nombre: "CRUZALTA", grupos: ["TODAS", "ROSARIO", "STAFE"] },
        ...
        { nombre: "FRONTERA", grupos: ["TODAS", "ROSARIO", "STAFE"] },
        ...
        { nombre: "J.POSSE", grupos: ["TODAS", "ROSARIO", "STAFE"] },
